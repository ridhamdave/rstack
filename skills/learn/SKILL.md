...
version: 1.0.0
description: |
  Manage project learnings. Review, search, prune, and export what rstack
...
~/.claude/skills/rstack/bin/rstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```
...
rstack will automatically capture patterns, pitfalls, and insights it discovers."
...
```bash
eval "$(~/.claude/skills/rstack/bin/rstack-slug 2>/dev/null)"
~/.claude/skills/rstack/bin/rstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(~/.claude/skills/rstack/bin/rstack-slug 2>/dev/null)"
~/.claude/skills/rstack/bin/rstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(~/.claude/skills/rstack/bin/rstack-slug 2>/dev/null)"
~/.claude/skills/rstack/bin/rstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
~/.claude/skills/rstack/bin/rstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```
