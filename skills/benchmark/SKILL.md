...
mkdir -p .rstack/benchmark-reports
mkdir -p .rstack/benchmark-reports/baselines
```
...
Write to `.rstack/benchmark-reports/baselines/baseline.json`.
...
Write to `.rstack/benchmark-reports/{date}-benchmark.md` and `.rstack/benchmark-reports/{date}-benchmark.json`.
