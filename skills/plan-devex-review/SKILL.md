...
description: |
  ...
  (APIs, CLIs, SDKs, libraries, platforms, docs). (rstack)
...
\`~/.claude/skills/rstack/plan-devex-review/dx-hall-of-fame.md\`
...
- **solo builder shipping MVP** -- 30-minute integration tolerance, won't read docs, copies from README
...
Load the "## Pass 1" section from `~/.claude/skills/rstack/plan-devex-review/dx-hall-of-fame.md`
...
`~/.rstack/` (user config directory, not project files).

```bash
~/.claude/skills/rstack/bin/rstack-review-log '{"skill":"plan-devex-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"product_type":"TYPE","tthw_current":"TTHW_CURRENT","tthw_target":"TTHW_TARGET","mode":"MODE","persona":"PERSONA","competitive_tier":"TIER","pass_scores":{"getting_started":N,"api_design":N,"errors":N,"docs":N,"upgrade":N,"dev_env":N,"community":N,"measurement":N},"unresolved":N,"commit":"COMMIT"}'
```
